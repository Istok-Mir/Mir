...
class LspRequest:
    ...
    def implementation(self,  params: lsp_types.ImplementationParams) -> Response[Union['lsp_types.Definition', List['lsp_types.LocationLink'], None]]:
        """ A request to resolve the implementation locations of a symbol at a given text
        document position. The request's parameter is of type {@link TextDocumentPositionParams}
        the response is of type {@link Definition} or a Thenable that resolves to such. """
        return self.send_request("textDocument/implementation", params)

    def type_definition(self,  params: lsp_types.TypeDefinitionParams) -> Response[Union['lsp_types.Definition', List['lsp_types.LocationLink'], None]]:
        """ A request to resolve the type definition locations of a symbol at a given text
        document position. The request's parameter is of type {@link TextDocumentPositionParams}
        the response is of type {@link Definition} or a Thenable that resolves to such. """
        return self.send_request("textDocument/typeDefinition", params)

    def document_color(self,  params: lsp_types.DocumentColorParams) -> Response[List['lsp_types.ColorInformation']]:
    ...
    def color_presentation(self,  params: lsp_types.ColorPresentationParams) -> Response[List['lsp_types.ColorPresentation']]:
    ...
    def folding_range(self,  params: lsp_types.FoldingRangeParams) -> Response[Union[List['lsp_types.FoldingRange'], None]]:
    ...
    def declaration(self,  params: lsp_types.DeclarationParams) -> Response[Union['lsp_types.Declaration', List['lsp_types.LocationLink'], None]]:
        """ A request to resolve the type definition locations of a symbol at a given text
        document position. The request's parameter is of type {@link TextDocumentPositionParams}
    ...
    def selection_range(self,  params: lsp_types.SelectionRangeParams) -> Response[Union[List['lsp_types.SelectionRange'], None]]:
    ...
    def prepare_call_hierarchy(self,  params: lsp_types.CallHierarchyPrepareParams) -> Response[Union[List['lsp_types.CallHierarchyItem'], None]]:
    ...
    def incoming_calls(self,  params: lsp_types.CallHierarchyIncomingCallsParams) -> Response[Union[List['lsp_types.CallHierarchyIncomingCall'], None]]:
        """ A request to resolve the incoming calls for a given `CallHierarchyItem`.

        @since 3.16.0 """
        return self.send_request("callHierarchy/incomingCalls", params)

    def outgoing_calls(self,  params: lsp_types.CallHierarchyOutgoingCallsParams) -> Response[Union[List['lsp_types.CallHierarchyOutgoingCall'], None]]:
        """ A request to resolve the outgoing calls for a given `CallHierarchyItem`.

        @since 3.16.0 """
        return self.send_request("callHierarchy/outgoingCalls", params)

    def semantic_tokens_full(self,  params: lsp_types.SemanticTokensParams) -> Response[Union['lsp_types.SemanticTokens', None]]:
        """ @since 3.16.0 """
        return self.send_request("textDocument/semanticTokens/full", params)

    def semantic_tokens_delta(self,  params: lsp_types.SemanticTokensDeltaParams) -> Response[Union['lsp_types.SemanticTokens', 'lsp_types.SemanticTokensDelta', None]]:
        """ @since 3.16.0 """
        return self.send_request("textDocument/semanticTokens/full/delta", params)

    def semantic_tokens_range(self,  params: lsp_types.SemanticTokensRangeParams) -> Response[Union['lsp_types.SemanticTokens', None]]:
        """ @since 3.16.0 """
        return self.send_request("textDocument/semanticTokens/range", params)

    def linked_editing_range(self,  params: lsp_types.LinkedEditingRangeParams) -> Response[Union['lsp_types.LinkedEditingRanges', None]]:
        """ A request to provide ranges that can be edited together.

        @since 3.16.0 """
        return self.send_request("textDocument/linkedEditingRange", params)

    def will_create_files(self,  params: lsp_types.CreateFilesParams) -> Response[Union['lsp_types.WorkspaceEdit', None]]:
    ...
    def will_rename_files(self,  params: lsp_types.RenameFilesParams) -> Response[Union['lsp_types.WorkspaceEdit', None]]:
    ...
    def will_delete_files(self,  params: lsp_types.DeleteFilesParams) -> Response[Union['lsp_types.WorkspaceEdit', None]]:
    ...
    def moniker(self,  params: lsp_types.MonikerParams) -> Response[Union[List['lsp_types.Moniker'], None]]:
        """ A request to get the moniker of a symbol at a given text document position.
        The request parameter is of type {@link TextDocumentPositionParams}.
        The response is of type {@link Moniker Moniker[]} or `null`. """
        return self.send_request("textDocument/moniker", params)

    def prepare_type_hierarchy(self,  params: lsp_types.TypeHierarchyPrepareParams) -> Response[Union[List['lsp_types.TypeHierarchyItem'], None]]:
    ...
    def type_hierarchy_supertypes(self,  params: lsp_types.TypeHierarchySupertypesParams) -> Response[Union[List['lsp_types.TypeHierarchyItem'], None]]:
        """ A request to resolve the supertypes for a given `TypeHierarchyItem`.

        @since 3.17.0 """
        return self.send_request("typeHierarchy/supertypes", params)

    def type_hierarchy_subtypes(self,  params: lsp_types.TypeHierarchySubtypesParams) -> Response[Union[List['lsp_types.TypeHierarchyItem'], None]]:
        """ A request to resolve the subtypes for a given `TypeHierarchyItem`.

        @since 3.17.0 """
        return self.send_request("typeHierarchy/subtypes", params)

    def inline_value(self,  params: lsp_types.InlineValueParams) -> Response[Union[List['lsp_types.InlineValue'], None]]:
    ...
    def inlay_hint(self,  params: lsp_types.InlayHintParams) -> Response[Union[List['lsp_types.InlayHint'], None]]:
    ...
    def resolve_inlay_hint(self,  params: lsp_types.InlayHint) -> Response['lsp_types.InlayHint']:
    ...
    def text_document_diagnostic(self,  params: lsp_types.DocumentDiagnosticParams) -> Response['lsp_types.DocumentDiagnosticReport']:
        """ The document diagnostic request definition.

        @since 3.17.0 """
        return self.send_request("textDocument/diagnostic", params)

    def workspace_diagnostic(self,  params: lsp_types.WorkspaceDiagnosticParams) -> Response['lsp_types.WorkspaceDiagnosticReport']:
        """ The workspace diagnostic request definition.

        @since 3.17.0 """
        return self.send_request("workspace/diagnostic", params)

    def inline_completion(self,  params: lsp_types.InlineCompletionParams) -> Response[Union['lsp_types.InlineCompletionList', List['lsp_types.InlineCompletionItem'], None]]:
    ...
    def initialize(self,  params: lsp_types.InitializeParams) -> Response['lsp_types.InitializeResult']:
    ...
    def will_save_wait_until(self,  params: lsp_types.WillSaveTextDocumentParams) -> Response[Union[List['lsp_types.TextEdit'], None]]:
    ...
    def completion(self,  params: lsp_types.CompletionParams) -> Response[Union[List['lsp_types.CompletionItem'], 'lsp_types.CompletionList', None]]:
    ...
    def resolve_completion_item(self,  params: lsp_types.CompletionItem) -> Response['lsp_types.CompletionItem']:
        """ Request to resolve additional information for a given completion item.The request's
        parameter is of type {@link CompletionItem} the response
        is of type {@link CompletionItem} or a Thenable that resolves to such. """
        return self.send_request("completionItem/resolve", params)

    def hover(self,  params: lsp_types.HoverParams) -> Response[Union['lsp_types.Hover', None]]:
        """ Request to request hover information at a given text document position. The request's
        parameter is of type {@link TextDocumentPosition} the response is of
        type {@link Hover} or a Thenable that resolves to such. """
        return self.send_request("textDocument/hover", params)

    def signature_help(self,  params: lsp_types.SignatureHelpParams) -> Response[Union['lsp_types.SignatureHelp', None]]:
        return self.send_request("textDocument/signatureHelp", params)

    def definition(self,  params: lsp_types.DefinitionParams) -> Response[Union['lsp_types.Definition', List['lsp_types.LocationLink'], None]]:
    ...
    def references(self,  params: lsp_types.ReferenceParams) -> Response[Union[List['lsp_types.Location'], None]]:
    ...
    def document_highlight(self,  params: lsp_types.DocumentHighlightParams) -> Response[Union[List['lsp_types.DocumentHighlight'], None]]:
    ...
    def document_symbol(self,  params: lsp_types.DocumentSymbolParams) -> Response[Union[List['lsp_types.SymbolInformation'], List['lsp_types.DocumentSymbol'], None]]:
    ...
    def code_action(self,  params: lsp_types.CodeActionParams) -> Response[Union[List[Union['lsp_types.Command', 'lsp_types.CodeAction']], None]]:
        """ A request to provide commands for the given text document and range. """
        return self.send_request("textDocument/codeAction", params)

    def resolve_code_action(self,  params: lsp_types.CodeAction) -> Response['lsp_types.CodeAction']:
        """ Request to resolve additional information for a given code action.The request's
        parameter is of type {@link CodeAction} the response
        is of type {@link CodeAction} or a Thenable that resolves to such. """
        return self.send_request("codeAction/resolve", params)

    def workspace_symbol(self,  params: lsp_types.WorkspaceSymbolParams) -> Response[Union[List['lsp_types.SymbolInformation'], List['lsp_types.WorkspaceSymbol'], None]]:
 ...
 """
    ...
    def resolve_workspace_symbol(self,  params: lsp_types.WorkspaceSymbol) -> Response['lsp_types.WorkspaceSymbol']:
    ...
    def code_lens(self,  params: lsp_types.CodeLensParams) -> Response[Union[List['lsp_types.CodeLens'], None]]:
        """ A request to provide code lens for the given text document. """
        return self.send_request("textDocument/codeLens", params)

    def resolve_code_lens(self,  params: lsp_types.CodeLens) -> Response['lsp_types.CodeLens']:
        """ A request to resolve a command for a given code lens. """
        return self.send_request("codeLens/resolve", params)

    def document_link(self,  params: lsp_types.DocumentLinkParams) -> Response[Union[List['lsp_types.DocumentLink'], None]]:
        """ A request to provide document links """
        return self.send_request("textDocument/documentLink", params)

    def resolve_document_link(self,  params: lsp_types.DocumentLink) -> Response['lsp_types.DocumentLink']:
        """ Request to resolve additional information for a given document link. The request's
        parameter is of type {@link DocumentLink} the response
        is of type {@link DocumentLink} or a Thenable that resolves to such. """
        return self.send_request("documentLink/resolve", params)

    def formatting(self,  params: lsp_types.DocumentFormattingParams) -> Response[Union[List['lsp_types.TextEdit'], None]]:
        """ A request to format a whole document. """
        return self.send_request("textDocument/formatting", params)

    def range_formatting(self,  params: lsp_types.DocumentRangeFormattingParams) -> Response[Union[List['lsp_types.TextEdit'], None]]:
        """ A request to format a range in a document. """
        return self.send_request("textDocument/rangeFormatting", params)

    def ranges_formatting(self,  params: lsp_types.DocumentRangesFormattingParams) -> Response[Union[List['lsp_types.TextEdit'], None]]:
    ...
    def on_type_formatting(self,  params: lsp_types.DocumentOnTypeFormattingParams) -> Response[Union[List['lsp_types.TextEdit'], None]]:
        """ A request to format a document on type. """
        return self.send_request("textDocument/onTypeFormatting", params)

    def rename(self,  params: lsp_types.RenameParams) -> Response[Union['lsp_types.WorkspaceEdit', None]]:
        """ A request to rename a symbol. """
        return self.send_request("textDocument/rename", params)

    def prepare_rename(self,  params: lsp_types.PrepareRenameParams) -> Response[Union['lsp_types.PrepareRenameResult', None]]:
        """ A request to test and perform the setup necessary for a rename.

        @since 3.16 - support for default behavior """
        return self.send_request("textDocument/prepareRename", params)

    def execute_command(self,  params: lsp_types.ExecuteCommandParams) -> Response[Union['lsp_types.LSPAny', None]]:
